...
<body>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Add Patient Panel</h1>
          <p></p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
          <li class="breadcrumb-item"><a href="">Patient profile / Add Patient</a></li>
        </ul>
      </div>
    ...
    <div class="col-md-6 m-auto">
      <div class="tile">
        ...
        <div class="tile-body">
          ...
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-users"></i> Add Patient </h3>
          ...
          <div class="form-group">
            ...
            <input type="number" name="age" id="age" class="form-control" placeholder="Age" autocomplete="off"  onkeyup="checkAge()" onblur="checkAge()">
            <span id="ageErr"></span>
          </div>
          <div class="form-group">
        ...
        document.getElementById("password").style.borderColor = "green";
         ...
         function checkAge(){
        	if (document.getElementById("age").value == "") {
			  	...
			  	document.getElementById("ageErr").style.color = "red";
			  	document.getElementById("age").style.borderColor = "red";
				document.getElementById("ageErr").innerHTML = "You are not allowed!";
			}
			else{
