      ...
      <li class="treeview ">
        ...
        <a class="app-menu__item" href="#" data-toggle="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li>
              <a class="treeview-item" href="add-patient.php">
               <i class="app-menu__icon fa fa-edit"></i></i> Add Patient</a>
            </li>
          </ul>
        </li>
        ...
        <a class="app-menu__item" href="#" data-toggle="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li>
              <a class="treeview-item" href="add-doctor.php">
                <i class="app-menu__icon fa fa-edit"></i> Add Doctor</a>
            </li>
          </ul>
        </li>
          ...
          <ul class="treeview-menu">
            ...
            <li>
              <a class="treeview-item" href="#">
                <i class="app-menu__icon fa fa-edit"></i> Add Pharmacist</a>
            </li>
          </ul>
        </li>
