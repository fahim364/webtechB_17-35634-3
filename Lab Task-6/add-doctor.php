...
<body>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Add Doctor Panel</h1>
          <p></p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
          <li class="breadcrumb-item"><a href="">Doctor profile / Add Doctor</a></li>
        </ul>
      </div>
    ...
    <div class="col-md-6 m-auto">
      <div class="tile">
        ...
        <div class="tile-body">
          ...
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-users"></i> Add Doctor </h3>
