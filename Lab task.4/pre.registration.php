...
<?php  
 ...
 {  
      ...
      {  
           $error = "<label class='text-danger'>Insert Phone number</label>";  
      }
                     ...
                     <form method="post">
                          <div class="box" >
                            ...
                            <div align="right" >
                             ...
                             <br>
                             <br>
                             <input type="text" name="phone" class="box2"  placeholder="Phone Number" style="height: 30px;width:290px;border:2px solid black">
                             <br>
                             <br>
